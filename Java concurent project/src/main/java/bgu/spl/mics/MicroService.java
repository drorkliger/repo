...
public abstract class MicroService implements Runnable {
    ...
    Map<Class<? extends Message>, Callback> messagesCallbackMap;
    ...
    public MicroService(String name) {
        ...
        messagesCallbackMap = new ConcurrentHashMap<>();
    }
    ...
    protected final <T, E extends Event<T>> void subscribeEvent(Class<E> type, Callback<E> callback) {
        messagesCallbackMap.putIfAbsent(type, callback);
    ...
    public final void run() {
        ...
        while (!terminated) {
            try{
                ...
                if(!messagesCallbackMap.isEmpty() && messagesCallbackMap.get(msg.getClass()) != null)
                    messagesCallbackMap.get(msg.getClass()).call(msg);
